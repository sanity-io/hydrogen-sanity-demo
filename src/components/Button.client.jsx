...
const DEFAULT_CLASSES =
  'block m-0 w-full items-center justify-center font-medium text-center px-6 py-4 disabled:border-gray-300 disabled:bg-gray-300 disabled:cursor-not-allowed';
